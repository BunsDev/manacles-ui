...
import { JSBI, Percent, Router, SwapParameters, Trade, TradeType } from 'manacles-sdk'
                ...
                return contract.callStatic[methodName](...args, options)
                  ...
                  .catch((callError) => {
                    ...
                    switch (callError.reason) {
                      case 'MancelesRouter: INSUFFICIENT_OUTPUT_AMOUNT':
                      case 'MancelesRouter: EXCESSIVE_INPUT_AMOUNT':
                        errorMessage =
