import { Token } from 'manacles-sdk'
import { transparentize } from 'polished'
import { Button, Text } from '@fooswap-libs/uikit'
        ...
        <AutoColumn gap="10px" justify="flex-start">
          ...
          {chainId && (
            <ExternalLink style={{ fontWeight: 400 }} href={getBscScanLink(chainId, token.address, 'token')}>
              <Blue title={token.address}>{shortenAddress(token.address)} (View on MantleExplorer)</Blue>
            </ExternalLink>
          )}
        </AutoColumn>
      </AutoRow>
